...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        transformCoordsSpace, getSceneCoordSystem, getObjectByName, getObjectName,
...
registerOnClick('Plane.006', false, false, [0,1,2], false, function(event) {
    tweenCamera('Scene', 'Scene', 1, function() {}, 1);
}, function(event) {});
registerOnClick('Plane', false, false, [0,1,2], false, function(event) {
    zoomCamera('Plane', 1, function() {});
}, function(event) {});
registerOnClick('Plane.003', false, false, [0,1,2], false, function(event) {
    zoomCamera('Plane.003', 1, function() {});
}, function(event) {});
registerOnClick('Plane.004', false, false, [0,1,2], false, function(event) {
    zoomCamera('Plane.004', 1, function() {});
}, function(event) {});
registerOnClick('Plane.005', false, false, [0,1,2], false, function(event) {
    zoomCamera('Plane.005', 1, function() {});
}, function(event) {});
registerOnClick('Plane.008', false, false, [0,1,2], false, function(event) {
    zoomCamera('Plane.008', 1, function() {});
}, function(event) {});
registerOnClick('Plane.009', false, false, [0,1,2], false, function(event) {
    zoomCamera('Plane.009', 1, function() {});
}, function(event) {});
registerOnClick('Plane.010', false, false, [0,1,2], false, function(event) {
    zoomCamera('Plane.010', 1, function() {});
}, function(event) {});
registerOnClick('Plane.011', false, false, [0,1,2], false, function(event) {
    zoomCamera('Plane.011', 1, function() {});
}, function(event) {});
